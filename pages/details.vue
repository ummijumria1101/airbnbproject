    ...
    <div>
        ...
        <div class="mb-[10px] flex gap-[5px] ">
            ...
            <div class="grid grid-cols-2 gap-[5px] rounded-r-xl">
                ...
                <img src="/img/superhost.png" class="w-[290px] h-[200px] ">
                <img src="/img/superhost.png" class="w-[290px] h-[200px] rounded-br-xl">
            </div>
        </div >
                ...
                <div>
                    ...
                    <div class="pb-[20px] border-b-2">
                        ...
                        <div class="flex gap-5 items-start mb-[20px]">
                            ...
                            <div>
                                ...
                                Diana adalah seorang HosTeladan.
                            </p>
                    ...
                    <div class="pb-[20px] border-b-2">
                            ...
                            <ul class="list-disc ml-[20px]">
                                <li>10 meter ke Toko Teh dan Kopi yang nyaman</li>
                                <li>3,5 km ke McDonalds Simpang Dago</li>
                                <li>4,8 km ke Ruang Seni Selasar Sunaryo</li>
                                <li>2,4 km ke Wi - Fi Kuliner Tradisional Warung Lela.</li>
                            </ul>
                            <p>...</p>
                            <p class="underline underline-offset-1 font-semibold">Tampilkan lebih banyak</p>
                    </div>

                    <!-- fasilitas yg ditawarkan -->
                    <div>
                        <p class="font-base text-2xl">Fasilitas yang ditawarkan</p>
                    </div>
                    <!-- isi fasilitas -->
